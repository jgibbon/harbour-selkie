...
#include "../Downloads/InternalDownloadItem.h"
...
//    std::shared_ptr<Settings> settings = sBrowserApplication->getSettings();
    ...
    m_enabled = settings->getValue(Settings::BrowserSetting::AdBlockPlusEnabled).toBool();
    m_configFile = settings->getPathValue(Settings::BrowserSetting::AdBlockPlusConfig);
    m_subscriptionDir = settings->getPathValue(Settings::BrowserSetting::AdBlockPlusDataDir);
...
//void AdBlockManager::setSettings(std::shared_ptr<Settings> settings)
//{
//    m_settings = settings;
//}
...
//void AdBlockManager::setBrowserHelper(BrowserHelper browserhelper)
//{
//    m_browserhelper = browserhelper;
//}
